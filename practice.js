...
/* =========================================================
   SOUND EFFECTS
========================================================= */
// Real recorded Cherry MX Blue switch samples from the open-source kbsim
// project (MIT licensed), embedded as base64 data URIs. Multiple press
// samples let rapid typing overlap; "typingSoundEnabled" (localStorage)
// remembers mute state between visits.
